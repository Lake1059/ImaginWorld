...
Partial Class 界面顶层_控制台
    ...
    Private Sub InitializeComponent()
        ...
        Panel1.Controls.Add(UiCheckBox11)
        Panel1.Controls.Add(UiCheckBox10)
        Panel1.Controls.Add(UiCheckBox9)
        Panel1.Controls.Add(UiCheckBox8)
        Panel1.Controls.Add(UiCheckBox7)
        Panel1.Controls.Add(UiCheckBox6)
        Panel1.Controls.Add(UiCheckBox5)
        Panel1.Controls.Add(UiCheckBox4)
        Panel1.Controls.Add(UiCheckBox3)
        Panel1.Controls.Add(UiCheckBox2)
        ...
        ' UiButton关闭控制台
        ' 
        UiButton关闭控制台.Dock = DockStyle.Right
        UiButton关闭控制台.FillColor = Color.FromArgb(CByte(48), CByte(48), CByte(48))
        UiButton关闭控制台.FillColor2 = Color.FromArgb(CByte(48), CByte(48), CByte(48))
        UiButton关闭控制台.FillDisableColor = Color.FromArgb(CByte(48), CByte(48), CByte(48))
        UiButton关闭控制台.FillHoverColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        UiButton关闭控制台.FillPressColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        UiButton关闭控制台.FillSelectedColor = Color.FromArgb(CByte(48), CByte(48), CByte(48))
        UiButton关闭控制台.Font = New Font("微软雅黑", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiButton关闭控制台.ForeColor = Color.Silver
        UiButton关闭控制台.ForeDisableColor = Color.Silver
        ...
        UiButton关闭控制台.RectDisableColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
    ...
    Friend WithEvents UiButton关闭控制台 As Sunny.UI.UIButton
