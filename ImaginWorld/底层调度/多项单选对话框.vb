Public Class 多项单选对话框
    ...
    Public Sub New(Title As String, SelectionGroup As String(), Optional Description As String = "", Optional DescriptionPanelHeight As Integer = 77, Optional WindowWidth As Integer = 350)
        ...
        newDialog.Width = WindowWidth * Form1.DPI
        If Description = "" Then
            newDialog.Panel1.Visible = False
            newDialog.Panel1.Height = 0
        Else
            newDialog.Label1.Text = Description
            newDialog.Panel1.Height = DescriptionPanelHeight * Form1.DPI
        End If
        For i = 0 To SelectionGroup.Length - 1
            ...
            a.SendToBack()
        Next
        newDialog.Panel2.Height = SelectionGroup.Length * (40 * Form1.DPI + 10 * Form1.DPI) + newDialog.Panel2.Padding.Bottom
        newDialog.MinimumSize = New Size(WindowWidth * Form1.DPI, 40 + DescriptionPanelHeight * Form1.DPI + newDialog.Panel2.Height)
    ...
    Public Sub New(Title As String, SelectionGroup As List(Of String), Optional Description As String = "", Optional DescriptionPanelHeight As Integer = 77, Optional WindowWidth As Integer = 350)
        ...
        For i = 0 To SelectionGroup.Count - 1
            ...
            a.SendToBack()
        Next
        newDialog.Panel2.Height = SelectionGroup.Count * (40 * Form1.DPI + 10) + newDialog.Panel2.Padding.Bottom
        newDialog.MinimumSize = New Size(WindowWidth * Form1.DPI, 40 + DescriptionPanelHeight * Form1.DPI + newDialog.Panel2.Height)
        newDialog.Height = newDialog.MinimumSize.Height
